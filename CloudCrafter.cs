...
    public Vector3 cloudPosMin = new Vector3(-50, -5, -20);
    public Vector3 cloudPosMax = new Vector3(150, 100, 20);
...
            //cPos.z = 100 - 90 * scaleU;               Commented out so that this does not interfere with parallax effect
...
            float scaleVal = cloud.transform.localScale.x;
            ...
            // Move larger clouds faster, edited to minimize this effect
            // cPos.x -= scaleVal * Time.deltaTime * cloudSpeedMult;
            cPos.x -= Time.deltaTime * cloudSpeedMult;

            // Move closer clouds faster
            float dist = Vector3.Distance(Camera.main.transform.position, cloud.transform.position);
           // Debug.Log(dist);
            cPos.x -= (1/dist) * 1200 * Time.deltaTime * cloudSpeedMult;
